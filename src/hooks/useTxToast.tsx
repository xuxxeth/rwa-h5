...
/** Step icon — active uses @property --border-angle to animate conic-gradient angle */
function StepIcon({ state, icon: IconComponent }: { state: StepState; icon: React.ComponentType<{ size: number; color?: string }> }) {
