  ...
  return (
    <div className={className || "content-stretch flex gap-[12px] items-center relative shrink-0 w-full"}>
      <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[1.5] min-w-px not-italic relative">
        <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[14px] text-white w-full">{t('v4.t75')}</p>
        <p className="font-['HarmonyOS_Sans_SC:Regular',sans-serif] relative shrink-0 text-[#9da3af] text-[12px] w-full">{t('v4.t76')}</p>
        <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[#9cff3a] text-[12px] w-full">{t('v4.t77')}</p>
      </div>
...
function Security2() {
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[1.5] min-w-px not-italic relative">
      <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[14px] text-white w-full">{t('v4.t78')}</p>
      <p className="font-['HarmonyOS_Sans_SC:Regular',sans-serif] relative shrink-0 text-[#9da3af] text-[12px] w-full">{t('v4.t79')}</p>
      <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[#9cff3a] text-[12px] w-full">{t('v4.t80')}</p>
    </div>
  );
}
...
function Security3() {
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[1.5] min-w-px not-italic relative">
      <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[14px] text-white w-full">{t('v4.t81')}</p>
      <p className="font-['HarmonyOS_Sans_SC:Regular',sans-serif] relative shrink-0 text-[#9da3af] text-[12px] w-full">{t('v4.t82')}</p>
      <p className="font-['HarmonyOS_Sans_SC:Medium',sans-serif] relative shrink-0 text-[#9cff3a] text-[12px] w-full">{t('v4.t80')}</p>
    </div>
  );
}
