  ...
  return (
    <Reveal delay={delay} className='h-full'>
      <div
        ...
        className='group relative h-[320px] md:h-[400px] p-6 md:p-8 rounded-3xl bg-[#1A1B1E] border border-white/5 overflow-hidden transition-all duration-500 hover:border-[#9CFF3A]/30 hover:bg-[#1A1B1E] hover:shadow-xl hover:shadow-[#9CFF3A]/10 flex flex-col justify-between'
      >
        <div
        ...
        <div className='relative z-20 h-full flex flex-col justify-end pointer-events-none'>
          ...
          <div>
            <h3 className='text-5xl md:text-8xl font-bold font-black text-transparent bg-clip-text bg-gradient-to-r from-white to-gray-500 mb-2 md:mb-4 tracking-tighter'>
              {value}
              <span className='text-3xl md:text-4xl text-[#9CFF3A] align-top ml-1'>{valueSuffix}</span>
            </h3>
            <h4 className='text-lg md:text-2xl font-bold text-white mb-1 md:mb-2 group-hover:text-[#9CFF3A] transition-colors duration-300'>
              {title}
            </h4>
            <p className='text-gray-400 text-sm md:text-lg font-light group-hover:text-gray-300 transition-colors'>
              {desc}
            </p>
          </div>
        </div>
