          ...
          {(t('trust.items', { returnObjects: true }) as TrustItem[]).map((item, idx) => {
            ...
            return (
              <div
                ...
                className='group relative bg-[#131416] border border-white/5 rounded-3xl p-6 md:p-8 overflow-hidden hover:border-[#9CFF3A]/30 transition-all duration-500 hover:-translate-y-2 flex flex-col h-full min-h-[250px] md:min-h-[300px]'
              >
