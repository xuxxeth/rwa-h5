...
export const Process: React.FC = () => {
  ...
  return (
    ...
    <Section id='process' className='bg-[#F8FAFC] !overflow-visible !pt-0 !pb-[80px]'>
      {/* Background Blurs Container */}
      <div className='absolute inset-0 overflow-hidden pointer-events-none'>
        <div className='absolute top-20 left-0 w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-[#B0F16B]/10 blur-[120px] rounded-full opacity-50' />
        <div className='absolute bottom-0 right-0 w-[300px] md:w-[600px] h-[300px] md:h-[600px] bg-[#939DFB]/10 blur-[120px] rounded-full opacity-50' />
      </div>
