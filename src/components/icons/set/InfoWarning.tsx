...
const InfoWarning = (props: SvgIconProps) => {
  return (
    <svg
      width={props.size}
      height={props.size}
    ...
    >
      <g clipPath="url(#clip0_info_warning)">
        <path
          ...
          fill={props.color || '#FFB219'}
        />
      </g>
      <defs>
        <clipPath id="clip0_info_warning">
...
const Icon = withIconColor(InfoWarning)
export default Icon
