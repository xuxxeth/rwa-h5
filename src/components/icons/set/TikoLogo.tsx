...
const TikoLogo = ({ size, color, className, onClick, ...rest }: SvgIconProps) => {
  const height = size ? Math.round((size / 56) * 21) : 21
  return (
    <svg
      width={size || 56}
      height={height}
    ...
    >
      ...
      />
      <path
        d="M14.625 6.75H10.125V18H4.5V6.75H0V2.25H14.625V6.75Z"
        fill={color || 'white'}
      />
      <path
...
const Icon = withIconColor(TikoLogo)
export default Icon
