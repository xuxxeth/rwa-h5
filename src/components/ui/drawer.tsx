...
const DrawerHeader = ({
  ...
  <div
    className={cn("px-6 py-4 text-center sm:text-left border-b border-solid border-[#41464F] flex justify-between items-center", className)}
    {...props}
  />
)
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "text-[16px] font-normal leading-none tracking-tight",
      className
    )}
    {...props}
  />
