...
const Compliance = () => {
  ...
  return (
    <Drawer open={show} onOpenChange={setShow} title={t('compliance.t1')} disableOutsideClose={true}
      overlayClassName='z-[999]'
      className='z-[1000] pointer-events-auto'
    >
      <div className='text-sm/4.5 font-normal overflow-auto px-6 py-4 max-h-[calc(90vh-82px)] text-white'>
