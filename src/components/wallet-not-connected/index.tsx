...
export function WalletNotConnectedSmallVersion() {
  ...
  return (
    <div className='flex flex-col gap-4 mt-10'>
      <LazyImage src='/images/v2/icons/connect-wallet.svg' className='h-[70px] m-auto' />
      <div className='text-base/4.5 font-medium text-center text-white'>
        {t('walletNotConnected')}
      </div>
      <div className='text-sm/[15px] font-normal text-center text-gray-400'>
        {t('connectWalletToView')}
      </div>
      <ConnectButtonText className='mt-6' />
    </div>
  )
}
